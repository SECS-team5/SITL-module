...
|-----|-----------|---------|------------|
| Центр верификации команд | verifier + sitl.verified-commands | Проверка входных команд, белый список, криптографическая подпись | Высокая (0.95) |
| Центр доверенной домашней позиции | sitl.verified-home | Контроль точки возврата, геозона, криптохэш дома | Высокая (0.85) |
...
| Mediator | messaging | Единая шина между компонентами (команды, телеметрия, события) | Низкое (0.20) |
